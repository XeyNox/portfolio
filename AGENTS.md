...
This project is indexed by GitNexus as **portfolio** (102 symbols, 120 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
