...
const SLIDES: Slide[] = [
    ...
    points: [
      {
        ...
        image: '/portfolio/oral/figma/wireframe-catalogue.png',
      },
      {
      ...
      },
      {
        ...
        image: '/portfolio/oral/figma/wireframe-detail-3d.png',
      },
      {
        ...
        image: '/portfolio/oral/figma/wireframe-detail-plans.png',
      },
      {
        ...
        image: '/portfolio/oral/figma/wireframe-detail-video.png',
      },
    ],
  },
    ...
    points: [
      {
        ...
        image: '/portfolio/oral/figma/app-accueil.jpg',
      },
      {
        ...
        image: '/portfolio/oral/figma/app-catalogue.jpg',
      },
      {
        ...
        image: '/portfolio/oral/figma/app-contact.jpg',
      },
    ],
  },

  {
    ...
    points: [
      { text: "Domain Layer — interfaces Repository, modèles métier purs", detail: "Le Domain Layer définit les contrats (interfaces Repository) et les modèles métier sans aucune dépendance Android. Il peut être testé en pur JVM sans émulateur.", image: '/portfolio/oral/code/repository-interface.png' },
      { text: "Data Layer — implémentations Room, DAOs, services (SMTP, email)", detail: "Le Data Layer implémente les interfaces du Domain : les DAOs Room accèdent à SQLite, et EmailService.kt gère l'envoi SMTP via Jakarta Mail sur Dispatchers.IO.", image: '/portfolio/oral/code/contact-dao.png' },
      { text: "Presentation Layer — ViewModels, états UI, composables Compose", detail: "Les ViewModels exposent des StateFlow d'états UI immuables. Les composables Compose s'abonnent via collectAsStateWithLifecycle() et se recomposent uniquement si l'état change.", image: '/portfolio/oral/code/viewmodel-stateflow.png' },
  ...
  },
  {
    ...
    points: [
      ...
      { text: "CONTACTS — id, société, email, téléphone, secteurs, photoPath, statut (pending|sent), timestamps", detail: "Le champ statut (pending | sent) permet de suivre l'état d'envoi email de chaque lead. Un indicateur visuel dans l'historique reflète ce statut en temps réel via Room Flow.", image: '/portfolio/oral/code/contact-entity.png' },
  ...
  },
  {
    ...
    points: [
      ...
      { text: "RepositoryModule — lie interfaces Domain aux implémentations Data", detail: "Koin mappe chaque interface du Domain vers son implémentation Data : bind<ContactRepository>() { ContactRepositoryImpl(get()) }. Le ViewModel ne voit jamais l'implémentation concrète.", image: '/portfolio/oral/code/koin-modules.png' },
  ...
  },
  {
    ...
    points: [
      ...
      { text: "Room Flow — mises à jour UI réactives sans polling", detail: "Les requêtes Room annotées @Query retournant Flow<T> s'appuient sur SQLite triggers internes. Room détecte chaque INSERT/UPDATE/DELETE et notifie automatiquement les collectors — zéro polling, zéro latence.", image: '/portfolio/oral/code/room-flow.png' },
  ...
  },
  {
    ...
    points: [
      ...
      { text: "Solution : EmailService.kt sur Dispatchers.IO via coroutine", detail: "EmailService.kt expose une suspend fun sendEmail() exécutée via withContext(Dispatchers.IO). ExportViewModel lance la coroutine dans viewModelScope — annulation automatique si l'écran est quitté pendant l'envoi.", image: '/portfolio/oral/code/email-service.png' },
